...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'second',
                loadChildren: () => __webpack_require__.e(/*! import() | servicios-servicios-module */ "servicios-servicios-module").then(__webpack_require__.bind(null, /*! ../servicios/servicios.module */ "./src/app/servicios/servicios.module.ts")).then(m => m.ServiciosPageModule)
            },
            {
                path: 'third',
                loadChildren: () => __webpack_require__.e(/*! import() | suscripcion-suscripcion-module */ "suscripcion-suscripcion-module").then(__webpack_require__.bind(null, /*! ../suscripcion/suscripcion.module */ "./src/app/suscripcion/suscripcion.module.ts")).then(m => m.SuscripcionPageModule)
            },
        ]
    }
];
