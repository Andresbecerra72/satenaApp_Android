...
var ExpandComponent = /** @class */ (function () {
    ...
    ExpandComponent.prototype.ngAfterViewInit = function () {
...
var ServiciosPageModule = /** @class */ (function () {
    function ServiciosPageModule(library) {
    ...
    ServiciosPageModule.ctorParameters = function () { return [
...
var ServiciosPage = /** @class */ (function () {
    ...
    ServiciosPage.prototype.expandedItem00 = function (item) {
        if (item.expanded) {
            item.expanded = false;
        }
        else {
            this.item00.map(function (listItem) {
                if (item == listItem) {
    ...
    //viajeros con armas
    //codigo para expandir el elemento cuando se hace click 
    ServiciosPage.prototype.expandedItem0 = function (item) {
        if (item.expanded) {
            item.expanded = false;
        }
        else {
            this.item0.map(function (listItem) {
                if (item == listItem) {
                    listItem.expanded = !listItem.expanded;
                }
                else {
    ...
    //codigo para expandir el elemento cuando se hace click 
    ServiciosPage.prototype.expandedItem1 = function (item) {
        if (item.expanded) {
            item.expanded = false;
        }
        else {
            this.item1.map(function (listItem) {
                if (item == listItem) {
                    listItem.expanded = !listItem.expanded;
                }
                else {
    ...
    //transporte de carga
    //codigo para expandir el elemento cuando se hace click 
    ServiciosPage.prototype.expandedItem2 = function (item) {
        if (item.expanded) {
            item.expanded = true;
        }
        else {
            this.item2.map(function (listItem) {
                if (item == listItem) {
                    listItem.expanded = !listItem.expanded;
                }
                else {
    ...
    //subitems de Carga
    //codigo para expandir el elemento cuando se hace click 
    ServiciosPage.prototype.expandedSubItems = function (item) {
        if (item.expanded) {
            item.expanded = false;
        }
        else {
            this.subitems.map(function (listItem) {
                if (item == listItem) {
                    listItem.expanded = !listItem.expanded;
                }
                else {
    ...
    ServiciosPage.prototype.toggle = function () {
